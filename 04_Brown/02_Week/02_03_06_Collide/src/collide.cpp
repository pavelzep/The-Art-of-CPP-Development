...
public:
    ...
    bool CollideWith(const Unit& that) { return collide(this.); }
    bool CollideWith(const Building& that) { return collide(this.); }
    bool CollideWith(const Tower& that) { return collide(this.); }
    bool CollideWith(const Fence& that) { return collide(this.); }
...
public:
    ...
    bool Collide(const GameObject& that) { return collide(this.); }
    bool CollideWith(const Unit& that) { return collide(this.); }
    bool CollideWith(const Building& that) { return collide(this.); }
    bool CollideWith(const Tower& that) { return collide(this.); }
    bool CollideWith(const Fence& that) { return collide(this.); }
